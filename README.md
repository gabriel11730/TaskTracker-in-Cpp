...
`createdA`t: The date and time when the task was created
...
1. Debo manejar Argv[1] correctamente, los comandos principales se procesan aqui
    - Convertirlo en un string
    - usar un despachador (if-else anidados)